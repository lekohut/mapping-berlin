...
$(function() {
	...
	var cloudantViews = [];
	$.getJSON('https://lekohut.cloudant.com/test/_design/tour/',
		function(result) {
...
function getLayer(callback, cloudantView) {
	var cloudantURLbase =
		"https://lekohut.cloudant.com/test/_design/tour/_view/";
...
function searchPoints(callback, cloudantSearch) {
	var cloudantURLbase =
		"https://lekohut.cloudant.com/test/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
...
function getPoints(cloudantIDs) {
	...
	function getPoint(id) {
		var cloudantURLbase = "https://lekohut.cloudant.com/test/";
